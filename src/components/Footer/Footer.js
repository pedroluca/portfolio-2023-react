  ...
  return (
    <div className="footer-bar">
      <nav>
        ...
        <a href="https://www.twitter.com/pedrolucaofc" target="blank" id="twitter"><span>twitter</span><img src={Twitter} alt="Twitter logo"/></a>
        <a href="https://www.youtube.com/channelUC7qDaMEUS4MjhQ7UVxQQVMQ/" target="blank" id="youtube"><span>youtube</span><img src={Youtube} alt="Youtube logo"/></a>
