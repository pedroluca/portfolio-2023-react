...
function Footer() {
  return (
    <div className="footer-bar">
      <nav>
        <a href="https://www.instagram.com/pe.uuh" target="blank" id="instagram"><img src={Instagram} alt="Instagram logo"/></a>
        <a href="https://www.github.com/pedroluca" target="blank" id="github"><img src={Github} alt="Github logo"/></a>
        <a href="https://www.linkedin.com/in/pedro-luca-prates" target="blank" id="linkedin"><img src={Linkedin} alt="Linkedin logo"/></a>
